...
import { useAppSelector, useOutClick } from "../../hooks/hooks";
...
export const Header: FC = () => {
    ...
    const handleClick = (e: React.MouseEvent<HTMLHeadElement> | MouseEvent) => {
    ...
    return (
        <header ref={ref} className={clsx({"header": !burgerActive, "header_burger-active": burgerActive})} onClick={(e) => handleClick(e)}>
            <div className="header__content">
                ...
                <div className={clsx({"header__nav-bar-burger": !burgerActive, "header__nav-bar-burger_active": burgerActive})} onClick={() => setBurgerActive(!burgerActive)}>
                    <div className="header__nav-bar__line"></div>
                    <div className="header__nav-bar__line"></div>
                </div>
                <NavBar />
            </div>
